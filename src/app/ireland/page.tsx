...
export default function IrelandItinerary() {
  return (
    <div>
      {/* Back to options */}
      <div className="bg-emerald-700 text-white py-2">
        <div className="max-w-6xl mx-auto px-4">
          <Link href="/" className="text-emerald-100 hover:text-white text-sm flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
              <path fillRule="evenodd" d="M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z" clipRule="evenodd" />
            </svg>
            View Portugal option
          </Link>
        </div>
      </div>

      <HeroSection
        title="Ireland Adventure"
